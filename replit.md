...
- July 04, 2025. **Quota OpenAI Issue**: Sistema pausado devido quota esgotada. Nova API key configurada mas problema persiste. Implementado aviso no painel administrativo com instruções detalhadas para resolução
